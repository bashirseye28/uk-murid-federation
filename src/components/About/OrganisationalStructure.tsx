    ...
    <section className="py-16 bg-gray-50 px-6">
      <div className="max-w-7xl mx-auto text-center mb-12">
        ...
        <p className="text-slate-600 mt-3 max-w-2xl mx-auto">
          Meet the individuals guiding our federation with wisdom, integrity,
          and dedication.
        </p>
      </div>
        ...
        {members.map((member, index) => {
          ...
          return (
            ...
            >
              ...
              />
              <h3 className="text-lg font-semibold text-mourid-green text-center">
                {member.name}
              </h3>
              <p className="text-sm text-mourid-blue font-medium text-center mb-2">
                {member.title}
              </p>
